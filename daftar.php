...
<br>
<button  class="btn waves-effect waves-light green left" type="submit" name="daftar">Daftar
...
<br><br><br><br>					
 		...
 		if (isset($_POST["daftar"])) 
 		{
			...
			// query insert ke tabel pelanggan 
 				$koneksi->query("INSERT INTO pelanggan (email_pelanggan,password_pelanggan,nama_pelanggan,alamat_pelanggan,telepon_pelanggan,foto_pelanggan,jk_pelanggan,tgl_lahir)
 					VALUES('$email','$password','$nama','$alamat','$telepon','$fotop','$jk_pelanggan','$tgl_lahir');");
