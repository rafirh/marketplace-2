...
<head>
	...
	<title>Daftar Penjual | Jejak.Kos </title>
</head>
<body>
	<!--Navbar-->
	...
	while($pelanggan = $ambil->fetch_assoc())
	{
		...
		<div class="container"><br><br>
			<h1 align="center">Daftar sebagai Penjual</h1>
					...
					<form action="" method="post" enctype="multipart/form-data">
						<div class="col-12 col-lg-12 col-xl-12">
							...
							<div class="input-field col s6">
								...
								<label for="phone" >Telepon Toko</label>
								<input id="phone"   name="phone" class="materialize-textarea validate" rows="5" required type="number">
							</div>
							<div class="input-field col s6">
								<i class="material-icons prefix">man</i>
								<label for="nik" >No Nik</label>
								<input id="nik"   name="nik" class="materialize-textarea validate" rows="5" required type="number">
							</div>
							<div class="input-field col s6">
