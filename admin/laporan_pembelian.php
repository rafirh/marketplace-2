...
?>
<br><br>
<h5 class="text-center mb-5">Laporan Pembelian <?php echo $tgl_mulai ?> Sampai <?php echo $tgl_selesai ?></h5>	
	<br><br><br><br>
	<form method="post">	
		<div class="row">
			<div class="col s12">
				...
				<label>Status Pengiriman</label>
					...
					<br>
						<button class="btn waves-effect brown col s2" name="kirim">LIHAT LAPORAN</button>		
				</div>	
			</div>	
		</div>
	</form>	
