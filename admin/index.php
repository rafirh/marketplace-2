...
<head>
  ...
  <title>Admin | Jejak.Kos</title>
 
</head>
<body>
  <div id="wrapper">
    <nav class="navbar-dark bg-danger" style="margin-bottom: 0">
  ...
  <!-- /. NAV TOP  -->
       <ul class="sidenav sidenav-fixed" id="slide-out" >
        <li class="text-center">
            <img src="../assets/img/admin/jejak.png" class="user-image img-responsive" width="100" height="100"/>
