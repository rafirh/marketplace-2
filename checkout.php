...
<head>
	...
	<title>Checkout | Jejak.Kos</title>
</head>
<body>
	<!--Navbar-->
...
<br> <br> <br>
					...
					if (isset($_POST["checkout"])) 
					{
						...
						$distrik_toko = $pecah['distrik_toko'];
						$resi_pengiriman = "";
						$total_pembelian = $totalbelanja + $ongkir; 

				//1. menyimpan data ke tabel pembelian
						$koneksi->query(" INSERT INTO pembelian (
							id_pengiriman,id_pelanggan,id_toko,tanggal_pembelian,total_pembelian,alamat_pengiriman,totalberat,provinsi,distrik,tipe,kodepos,ekspedisi,paket,ongkir,estimasi,distrik_toko,resi_pengiriman)
							VALUES (5, '$id_pelanggan','$id_toko','$tanggal_pembelian','$total_pembelian','$alamat_pengiriman','$totalberat','$provinsi','$distrik','$tipe','$kodepos','$ekspedisi','$paket','$ongkir','$estimasi','$distrik_toko','$resi_pengiriman') ");
