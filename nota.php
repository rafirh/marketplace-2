...
<head>
	...
	<title>Nota Pembelian | Jejak.Kos</title>
	<style>
		.watermark{
			position: relative; 
		}
		...
		<div class="container ">
			...
			<?php else: ?>
				...
				<div class="row">
					<div class="col s12">
						<!-- 	<div class="card-panel  hoverable"> -->
							<span class="black-text">
								<div class="row">
									<div class="col s3">
										<h5><strong>Silahkan Bayar Sesuai Tagihan</strong></h5>
									</div>
									...
									<div class="col s3">
										...
										: <?php echo number_format($pecah['telepon_pelanggan']); ?><br>
										: <?php echo $pecah['email_pelanggan'] ;?><br>		
									</div>
									<div class="col s1">
										<strong>
											Ekspedisi <br>
					...
					<img src="assets/img/homepage/jejak.png" class="img-watermark">
